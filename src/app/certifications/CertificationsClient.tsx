            ...
            <div className="flex justify-center w-full">
              {credentials.map((cred, index) => (
                <motion.div
                  ...
                  className="bg-white border border-border-light rounded-[18px] p-8 shadow-sm hover:shadow-xl hover:border-primary/20 transition-all duration-300 flex flex-col justify-between h-full group max-w-md w-full"
                >
                  <div>
